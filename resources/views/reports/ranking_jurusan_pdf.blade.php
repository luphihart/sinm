...
<head>
    <meta charset="UTF-8">
    <title>Laporan Ranking Paralel Jurusan - {{ $jurusan->kode_jurusan }} (Tingkat {{ $tingkat }})</title>
    <style>
        @page {
...
<body>
    ...
    <h3 class="text-center" style="margin-bottom: 15px; text-transform: uppercase; font-size: 11pt;">Laporan Ranking Paralel Jurusan</h3>

    <table class="info-table">
        <tr>
            <td class="info-label">Jurusan</td>
            <td class="info-colon">:</td>
            <td class="info-value"><strong>{{ $jurusan->nama_jurusan }} ({{ $jurusan->kode_jurusan }})</strong></td>
        </tr>
        <tr>
            <td class="info-label">Tingkat</td>
            <td class="info-colon">:</td>
            <td class="info-value">Tingkat {{ $tingkat }}</td>
        </tr>
        <tr>
    ...
    <table class="leaderboard-table">
        <thead>
            <tr>
                <th width="80px">Peringkat Paralel</th>
        ...
        <tbody>
            @forelse($rankingList as $row)
                <tr>
                    <td class="text-center" style="font-weight: bold;">{{ $row->rank_paralel }}</td>
                    ...
                    <td class="text-center" style="font-weight: bold; color: #0d9488;">{{ number_format($row->avg_nilai, 2) }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" class="text-center" style="padding: 15px; color: #64748b;">Belum ada data nilai paralel jurusan pada semester ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
